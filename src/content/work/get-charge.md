...
draft: false
screenshots:
  - src: ./images/get-charge/01-map.png
    alt: "Map view — station locations across Europe"
  - src: ./images/get-charge/02-filter.png
    alt: "Filter panel — filter stations by connector type and operator"
  - src: ./images/get-charge/03-search.png
    alt: "Search — find charging stations by location or address"
  - src: ./images/get-charge/04-station.png
    alt: "Station detail — availability, pricing, and connector info"
  - src: ./images/get-charge/05-charging.png
    alt: "Active charging session — live status and cost tracker"
  - src: ./images/get-charge/06-history.png
